...
const getMarks = ({
    ...
    const mat = ((maths - 10) * 20) / 90;

    const phy = ((physics - 30) * 20) / 70;

    const che = ((chemistry - 30) * 20) / 70;

    const comp_bio = ((cs_bio - 30) * 20) / 70;
    const eleventh_total = tam + eng + mat + phy + che + comp_bio;
...
const getSubMarks = ({
    ...
    const Biology = tenth_avg + comp_bio + 30;
    ...
    return {
        ...
        cs_bio: Number(Biology.toFixed(2)),
    };
};
const Input = ({
    value,
    ...
    return (
        <main className="container p-6">
            ...
            <div className="p-4">
                ...
                />
                <Input
                    value={(inputs as InputTypes).maths}
                    name="maths"
                ...
                />
                <Input
                    value={(inputs as InputTypes).cs_bio}
                    name="cs_bio"
                    placeholder="Class 11 Computer Science / Biology Mark"
                    onChange={handleChange}
                />
            </div>
